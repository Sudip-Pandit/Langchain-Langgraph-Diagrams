...
First, the system understands and cleans up what the user is actually asking for. Then it figures out how complex the request is and routes it accordingly. From there, it plans out the specific steps needed, brings in tools when necessary, checks the output for accuracy and safety, and finally formats everything into a usable response.
